...
;(function (factory) {
    ...
    $.fn.animatedHeadline = function (options) {
        ...
        $(this).each(function () {
            ...
            var $element_blocks_alt_layer = $element_blocks.find('div');
            ...
            tl.add('move-in').to('.block-1', 1, { x: 0, y: 0, scale: 1 }, 'move-in').to('.block-2', 1, { x: 0, y: 0, scale: 1 }, 'move-in').to('.block-3', 1, { x: 0, y: 0, scale: 1 }, 'move-in').to('.block-4', 1, { x: 0, y: 0, scale: 1 }, 'move-in');
